---
title: "Wprowadzenie do Modelowania Predykcyjnego"
subtitle: "Z językiem R i pakietami randomForest, mlr3 oraz DALEX"
author: "Przemyslaw Biecek oraz Anna Kozak"
date: "15.01.2022"
output: 
  html_document:
    toc: true
...
# *Rozdział 1: Modelowanie predykcyjne*

```
install.packages(c("tableone", "DALEX", "ggplot2", "partykit", "mlr3", "mlr3learners", "ranger", "mlr3tuning", "paradox"))
```

# Część 1: Wprowadzenie do modelownia predykcyjnego + EDA

Celem tego poradnika jest przedstawienie cyklu życia pojedynczego modelu predykcyjnego dla problemu związanego z klasyfikacją binarną (ale celowo nie wspominam o regresji logistycznej). Po drodze będziemy poruszać różne ciekawe tematy, takie jak trening modelu, weryfikacja modelu, strojenie hiperparametrów i eksploracyjna analiza modelu. 

Prezentowane tu przykłady są inspirowane trzema podręcznikami: [The Elements of Statistical Learning](https://www.statlearning.com/) o podstawach matematycznych, [The mlr3 book](https://mlr3book.mlr-org.com/), prezentująca pakiet oprogramowania `mlr3` przeznaczony do zaawansowanego programowania modeli, [Explanatory Model Analysis](http://ema.drwhy.ai/) przegląd metod eksploracji i wizualizacji modeli. 
Należy pamiętać, że odpowiedzialne modelowanie wymaga wiedzy, której nie da się przyswoić w dwa dni.  
Tak więc, po tym wstępie, gorąco polecam zapoznanie się z tymi książkami.
...
# Część 2: Hej model! Pierwszy predykcyjny moedl + jak mierzyć jakość modelu
...
# Część 3: Podstawy drzew decyzyjnych i lasów losowych
...
# Cześć 4: Optymalizacja hiperparametrów + podsumowanie
...
![PiramidaXAI](PiramidaXAI.png)

# Część 1: Analiza na poziomie modelu - ważność zmiennych
...
# Część 2: Analiza modelu - profil odpowiedzi zmiennych
...
# Część 3: Analiza na poziomie instancji - attrybucja zmiennych
...
# Część 4: Analiza na poziomie instancji - profil odpowiedzi zmiennej + Podsumowanie
